  ...
  return (
    <div className="bg-background text-foreground min-h-screen relative">
      ...
      <section id="home" className="relative h-screen overflow-hidden">
        ...
        <motion.div className="relative h-full flex flex-col items-center justify-center text-center px-4" initial="hidden" animate="visible" variants={containerVariants}>
